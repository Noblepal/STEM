...
<head>
    ...
    <title>Stem | Loan Applications</title>
    <!-- Bootstrap core CSS -->
...
<body>
            ...
            <div class="row">
                <div class="col-md-10">
                    <h1>
                        ...
                        <small>Manage loan applications</small>
                    </h1>
                </div>
                <div class="col-md-2">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="list-group">
                        ...
                        <a href="loans.php" class="list-group-item active main-color-bg">
                ...
                <div class="col-md-9">
                    <div class="panel panel-default">
                        <div class="panel-heading main-color-bg">
                            <h3 class="panel-title">New Applications</h3>
                        </div>
    ...
    <!-- Add User Modal -->
    <div class="modal fade" id="addUser" tabindex="-1" role="dialog" aria-labelledby="addUserModal">
...
<div class="modal fade" id="approveLoan" tabindex="-1" role="dialog" aria-labelledby="approveLoanModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="approveLoanModal">Approve Loan</h4>
                    </div>
                    <div class="modal-body">
                        <div class="col-sm-12">
                            <div class="row">
